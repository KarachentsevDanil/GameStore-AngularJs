...
<div>
    <div class="row">
        <div class="col-lg-9 col-sm-12">
         ...
         <v-text-field
                :label="resources.properties.creditCardNumberLabel"
        ...
        <div class="col-lg-3 col-sm-12">
            <v-text-field
                :label="resources.properties.cvvCodeLabel"
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12">
            <v-select
                :label="resources.properties.expirationMonthLabel"
        ...
        <div class="col-lg-6 col-sm-12">
        <v-select
                :label="resources.properties.expirationYearLabel"
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <v-select
                        :label="resources.properties.countryLabel"
        ...
        <v-text-field
                :label="resources.properties.fullNameLabel"
